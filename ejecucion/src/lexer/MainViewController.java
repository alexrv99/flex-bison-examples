...
public class MainViewController {
    ...
    public void initialize() {
        ...
        txtOutput.focusedProperty().addListener((observable, oldValue, newValue) ->
                Platform.runLater(() -> txtOutput.end()));
        txtOutput.setOnKeyReleased(event -> {
            ...
            if (event.getCode() == KeyCode.ENTER) {
                ...
                try {
                    ...
                    showError("Ha ocurrido un error en la ejecucion");
                    e.printStackTrace();
                }
            }
        });
    ...
    public void analyze() {
        ...
        try {
            ...
            showError("Ha ocurrido un error lexico");
            e.printStackTrace();
        }
    ...
    private List<VciElement> generateVci(List<LexerElement> elements) {
        ...
        for (int i = 0; i < elements.size(); i++) {
            ...
            if (token.equals(Token.AbreParentesis)) {
                ...
                } else if (poppedElement.getToken().equals(Token.Else) || poppedElement.getToken().equals(Token.If)) {
        ...
        vci.forEach(System.out::println);
    ...
    private void executeCode(List<VciElement> vci, int startInstruction) throws Exception {
            ...
            if (vciElement.getToken() == null) {
                ...
                try {
                    ...
                    try {
                        ...
                        showError("La variable " + item + " no tiene un valor");
                        return;
                    }
                }
                ...
                try {
                    ...
                    readInput = "";
                    System.out.println("readInput = \"\", next is symbolsTable: " + symbolsTable);
                } catch (NumberFormatException e) {
                    showError("Error al convertir " + readInput + " a double");
                    e.printStackTrace();
                }
